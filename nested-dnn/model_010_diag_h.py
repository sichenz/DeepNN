...
class Model(ModelBase):
    """
    model 005 + manually defined discount bottleneck
    ...
    def __init__(self, J, T, K, L, epsilon, pretrained):
        ...
        # product embedding
        self.w_conv_j = nn.Parameter(torch.FloatTensor(J, J).uniform_(-0.025, 0.025))
    ...
    def forward(self, in_pf, in_np, in_bc):
        ...
        # product convolution
        bc_conv_tj_out = torch.einsum("bki,ij->bkj", bc_conv_t, self.w_conv_j)
